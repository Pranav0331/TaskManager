    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-white leading-tight mb-4">
              Manage tasks with<br />clarity and speed
            </h2>
            <p className="text-brand-200 text-lg max-w-md">
              The premium task management platform designed for modern teams who value productivity and elegance.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-nimbus-950">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-nimbus-900 dark:text-white mb-2">Welcome back</h2>
          <p className="text-nimbus-500 mb-8">Sign in to your account to continue</p>
